...
fig = go.Figure(data=[go.Scatter3d(x=X_2800, y=Y_2800, z=Z_2800, mode='markers', marker=dict(size=1, color=Z_2800, colorscale='Spectral', colorbar=dict(tickvals=ztick_values, ticktext=ztick_text,title_side='right', title=dict(text='Crustal Thickness Below 2800 msec', font=dict(size=20)),tickfont=dict(size=16))))])

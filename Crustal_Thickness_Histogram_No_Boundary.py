...
bins = [0, 1400, 2800, 4200, 5600, 7000, 8400, 9800,
        11200, 12600, 14000, 15400, 16800]
bins_labels = ['0-1.4', '1.4-2.8', '2.8-4.2', '4.2-5.6',
               '5.6-7.0', '7.0-8.4', '8.4-9.8', '9.8-11.2',
               '11.2-12.6', '12.6-14.0', '14.0-15.4', '15.4-16.8']
...
ax.set_xlabel('Crustal Thickness (s)', fontsize=18)
...
ax.axhline(mean_crustal_thickness, color='red',
           linestyle='-.', linewidth=2,
           label=f'Mean Crustal Thickness: {mean_crustal_thickness:.2f} msec')
ax.axhline(median_crustal_thickness, color='Magenta',
           linestyle=':', linewidth=3,
           label=f'Median Crustal Thickness: {median_crustal_thickness:.2f} msec')
ax.axhline(std_dev_crustal_thickness, color='Orange',
           linestyle='-', linewidth=2,
           label=f'Standard Deviation Crustal Thickness: {std_dev_crustal_thickness:.2f} msec')

...
ytick_values = [5100000, 5200000, 5300000, 5400000, 5500000,
                5600000, 5700000, 5800000]
ytick_text = ['5100000', '5200000', '5300000', '5400000', '5500000',
              '5600000', '5700000', '5800000']
...
fig = go.Figure(data=[go.Surface(x=X1, y=Y1, z=smoothed_Z1_clean, colorscale='Spectral',
                colorbar=dict(tickvals=ztick_values, ticktext=ztick_text, title_side='right',
                title=dict(text='Crustal Thickness (msec)', font=dict(size=20)),
                tickfont=dict(size=16)), contours={"z": {"show": True, "start": 0, "end": 11000, "size": 1500}})])
